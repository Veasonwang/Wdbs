...
namespace Wdbs
{
    public partial class FormQueryBySpace : Form
    {
        ...
        public FormQueryBySpace()
        {
            InitializeComponent();
        }

        //窗体加载时触发事件，执行本函数
        private void FormQueryBySpace_Load(object sender, EventArgs e)
        {
            try
            {
                //清空目标图层列表
        ...
        /// 根据已配置的查询条件来执行空间查询操作。
        /// </summary>
        private void SelectFeaturesBySpace()
        {
